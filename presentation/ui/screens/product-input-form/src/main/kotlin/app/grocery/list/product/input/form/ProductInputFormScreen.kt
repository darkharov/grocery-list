    ...
    Column(
        modifier = modifier
            ...
            .padding(
                ...
                vertical = 4.dp + dimensionResource(R.dimen.margin_16_32_64),
            ),
    ) {
        Spacer(
            modifier = Modifier
        ...
        val productListsDropdown = props.productListsDropdown
        if (productListsDropdown != null) {
            AppDropdownMenu(
                props = productListsDropdown,
                onExpandedChange = { newValue ->
