...
class MainActivity :
    ...
    @Inject lateinit var productListToSharingStringFormatter: ProductListToSharingStringFormatter
    ...
    override fun share(products: List<Product>) {
        ...
        val text = productListToSharingStringFormatter.print(products, suffix = suffix)
        share(text = text)
    }
}
